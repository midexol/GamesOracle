...
export default function Whitepaper() {
  ...
  return (
    <div className="article" style={{ maxWidth: '840px', padding: '40px 32px 80px' }}>
      ...
      {/* Table of Contents */}
      <div style={{ background: 'var(--paper-2)', padding: '24px', border: '1px solid var(--rule)', marginBottom: '40px' }}>
        <h4 className="mono" style={{ margin: '0 0 12px', fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.08em', borderBottom: '1px solid var(--ink)', paddingBottom: '6px' }}>
          Table of Contents
        </h4>
        <ul className="mono" style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: '12px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <li>
            <a onClick={() => scrollToSection('sec-abstract')} style={{ cursor: 'pointer', borderBottom: '1px dotted var(--muted)' }}>
              1. Abstract
            </a>
          </li>
          <li>
            <a onClick={() => scrollToSection('sec-problem')} style={{ cursor: 'pointer', borderBottom: '1px dotted var(--muted)' }}>
              2. Problem Statement
            </a>
          </li>
          <li>
            <a onClick={() => scrollToSection('sec-solution')} style={{ cursor: 'pointer', borderBottom: '1px dotted var(--muted)' }}>
              3. Solution Overview
            </a>
          </li>
          <li>
            <a onClick={() => scrollToSection('sec-howitworks')} style={{ cursor: 'pointer', borderBottom: '1px dotted var(--muted)' }}>
              4. How It Works
            </a>
          </li>
          <li>
            <a onClick={() => scrollToSection('sec-architecture')} style={{ cursor: 'pointer', borderBottom: '1px dotted var(--muted)' }}>
              5. System Architecture
            </a>
          </li>
          <li>
            <a onClick={() => scrollToSection('sec-contracts')} style={{ cursor: 'pointer', borderBottom: '1px dotted var(--muted)' }}>
              6. Smart Contract Design
            </a>
          </li>
          <li>
            <a onClick={() => scrollToSection('sec-fees')} style={{ cursor: 'pointer', borderBottom: '1px dotted var(--muted)' }}>
              7. Fee Model and Monetization
            </a>
          </li>
          <li>
            <a onClick={() => scrollToSection('sec-asp')} style={{ cursor: 'pointer', borderBottom: '1px dotted var(--muted)' }}>
              8. ASP Integration (OKX.AI)
            </a>
          </li>
          <li>
            <a onClick={() => scrollToSection('sec-roadmap')} style={{ cursor: 'pointer', borderBottom: '1px dotted var(--muted)' }}>
              9. Roadmap
            </a>
          </li>
          <li>
            <a onClick={() => scrollToSection('sec-risks')} style={{ cursor: 'pointer', borderBottom: '1px dotted var(--muted)' }}>
              10. Risks and Open Questions
            </a>
          </li>
          <li>
            <a onClick={() => scrollToSection('sec-conclusion')} style={{ cursor: 'pointer', borderBottom: '1px dotted var(--muted)' }}>
              11. Conclusion
            </a>
          </li>
        </ul>
      ...
      {/* Main Content */}
      <div className="body-text" style={{ fontSize: '15px', lineHeight: '1.8', textAlign: 'justify' }}>
        
        {/* Section 1 */}
        <section id="sec-abstract" style={{ marginBottom: '40px' }}>
          <h3 className="display" style={{ fontSize: '22px', borderBottom: '1px solid var(--ink)', paddingBottom: '6px', marginTop: '30px' }}>
            1. Abstract
          </h3>
          <p>
        ...
        {/* Section 2 */}
        <section id="sec-problem" style={{ marginBottom: '40px' }}>
          <h3 className="display" style={{ fontSize: '22px', borderBottom: '1px solid var(--ink)', paddingBottom: '6px', marginTop: '30px' }}>
            2. Problem Statement
          </h3>
          <p>
          ...
          <h4 className="mono" style={{ fontSize: '13px', margin: '20px 0 8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
        ...
        {/* Section 3 */}
        <section id="sec-solution" style={{ marginBottom: '40px' }}>
          <h3 className="display" style={{ fontSize: '22px', borderBottom: '1px solid var(--ink)', paddingBottom: '6px', marginTop: '30px' }}>
            3. Solution Overview
          </h3>
          <p>
        ...
        {/* Section 4 */}
        <section id="sec-howitworks" style={{ marginBottom: '40px' }}>
          <h3 className="display" style={{ fontSize: '22px', borderBottom: '1px solid var(--ink)', paddingBottom: '6px', marginTop: '30px' }}>
            4. How It Works
          </h3>
          <h4 className="mono" style={{ fontSize: '13px', margin: '20px 0 8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
        ...
        {/* Section 5 */}
        <section id="sec-architecture" style={{ marginBottom: '40px' }}>
          <h3 className="display" style={{ fontSize: '22px', borderBottom: '1px solid var(--ink)', paddingBottom: '6px', marginTop: '30px' }}>
            5. System Architecture
          </h3>
          <p>
        ...
        {/* Section 6 */}
        <section id="sec-contracts" style={{ marginBottom: '40px' }}>
          <h3 className="display" style={{ fontSize: '22px', borderBottom: '1px solid var(--ink)', paddingBottom: '6px', marginTop: '30px' }}>
            6. Smart Contract Design
          </h3>
          <p>
        ...
        {/* Section 7 */}
        <section id="sec-fees" style={{ marginBottom: '40px' }}>
          <h3 className="display" style={{ fontSize: '22px', borderBottom: '1px solid var(--ink)', paddingBottom: '6px', marginTop: '30px' }}>
            7. Fee Model and Monetization
          </h3>
          <p>
        ...
        {/* Section 8 */}
        <section id="sec-asp" style={{ marginBottom: '40px' }}>
          <h3 className="display" style={{ fontSize: '22px', borderBottom: '1px solid var(--ink)', paddingBottom: '6px', marginTop: '30px' }}>
            8. ASP Integration (OKX.AI)
          </h3>
          <p>
        ...
        {/* Section 9 */}
        <section id="sec-roadmap" style={{ marginBottom: '40px' }}>
          <h3 className="display" style={{ fontSize: '22px', borderBottom: '1px solid var(--ink)', paddingBottom: '6px', marginTop: '30px' }}>
            9. Roadmap
          </h3>
          <h4 className="mono" style={{ fontSize: '13px', margin: '20px 0 8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
        ...
        {/* Section 10 */}
        <section id="sec-risks" style={{ marginBottom: '40px' }}>
          <h3 className="display" style={{ fontSize: '22px', borderBottom: '1px solid var(--ink)', paddingBottom: '6px', marginTop: '30px' }}>
            10. Risks and Open Questions
          </h3>
          <ul style={{ paddingLeft: '20px', marginBottom: '16px' }}>
        ...
        {/* Section 11 */}
        <section id="sec-conclusion" style={{ marginBottom: '40px' }}>
          <h3 className="display" style={{ fontSize: '22px', borderBottom: '1px solid var(--ink)', paddingBottom: '6px', marginTop: '30px' }}>
            11. Conclusion
          </h3>
          <p>
